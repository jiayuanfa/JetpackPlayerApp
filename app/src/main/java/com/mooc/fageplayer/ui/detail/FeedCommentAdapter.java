...
import com.mooc.fageplayer.databinding.LayoutFeedDetailCommentListItemBinding;
...
public class FeedCommentAdapter extends AbsPagedListAdapter<Comment, FeedCommentAdapter.ViewHolder> {
    ...
    protected ViewHolder onCreateViewHolder2(ViewGroup parent, int viewType) {
        LayoutFeedDetailCommentListItemBinding layoutFeedDetailCommentListItemBinding = LayoutFeedDetailCommentListItemBinding.inflate(mInflater, parent, false);
        return new ViewHolder(layoutFeedDetailCommentListItemBinding.getRoot(), layoutFeedDetailCommentListItemBinding);
    }
...
//            PreviewActivity.startActivityForResult((Activity) mContext, isVideo ? item.videoUrl : item.imageUrl, isVideo, null);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private LayoutFeedDetailCommentListItemBinding mBinding;

        public ViewHolder(@NonNull View itemView, LayoutFeedDetailCommentListItemBinding binding) {
            super(itemView);
            mBinding = binding;
        }
