package com.mooc.fageplayer.ui.publish;
...
import com.mooc.fageplayer.databinding.ActivityLayoutCaptureBinding;
import com.mooc.fageplayer.view.RecordView;
...
public class CaptureActivity extends AppCompatActivity {
    ...
    private void bindCameraX() {
        ...
        if (!hasAvailableCameraId) {
            showErrorToast("无可用的设备cameraId!, 请检查设备的相机是否正在被占用");
            finish();
            return;
        }
        ...
        // 下面我们要查询一下 当前设备他们支持的分辨率有哪些 然后更新一下 所配置的几个useCase
